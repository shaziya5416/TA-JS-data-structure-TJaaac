...
console.log(person.address == personTwo.address); // true
console.log(personTwo.address.city); // output SanJose
console.log(person.address.city); // SanHose
...
// Your code goes here
```
let questionClone={... questions,responses:[... questions]};
...
// Your code goes here
```
let allBlogsClone={... allBlogs,author:{ ... allBlogsClone}};
...
// Your code goes here
```
let clonedPerson={... person,input:{...person}.output:{...person}};
